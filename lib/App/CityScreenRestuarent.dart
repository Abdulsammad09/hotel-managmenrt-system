import 'dart:convert';
import 'package:citieguide/App/RestaurantScreen.dart';
...
class AppCityScreenResturant extends StatefulWidget {
  @override
  _AppCityScreenResturantState createState() => _AppCityScreenResturantState();
}

class _AppCityScreenResturantState extends State<AppCityScreenResturant> {
  List<dynamic> cities = [];
